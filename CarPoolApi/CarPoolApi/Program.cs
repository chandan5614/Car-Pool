...
builder.Services.AddScoped<IUserRepository>(provider =>
{
    ...
    var containerName = builder.Configuration["ConnectionStrings:UserContainerName"];
...
builder.Services.AddScoped<IBookingRepository>(provider =>
{
    var cosmosClient = provider.GetRequiredService<CosmosClient>();
    var databaseName = builder.Configuration["ConnectionStrings:DatabaseName"];
    var containerName = builder.Configuration["ConnectionStrings:BookingContainerName"];
...
builder.Services.AddScoped<IRideRepository>(provider =>
{
    var cosmosClient = provider.GetRequiredService<CosmosClient>();
    var databaseName = builder.Configuration["ConnectionStrings:DatabaseName"];
    var containerName = builder.Configuration["ConnectionStrings:RideContainerName"];
...
builder.Services.AddScoped<IPaymentRepository>(provider =>
{
    var cosmosClient = provider.GetRequiredService<CosmosClient>();
    var databaseName = builder.Configuration["ConnectionStrings:DatabaseName"];
    var containerName = builder.Configuration["ConnectionStrings:PaymentContainerName"];
...
builder.Services.AddScoped<IRatingRepository>(provider =>
{
    var cosmosClient = provider.GetRequiredService<CosmosClient>();
    var databaseName = builder.Configuration["ConnectionStrings:DatabaseName"];
    var containerName = builder.Configuration["ConnectionStrings:RatingContainerName"];
...
builder.Services.AddScoped<IScheduleRepository>(provider =>
{
    var cosmosClient = provider.GetRequiredService<CosmosClient>();
    var databaseName = builder.Configuration["ConnectionStrings:DatabaseName"];
    var containerName = builder.Configuration["ConnectionStrings:ScheduleContainerName"];
